...
async function handleSignin() {
  ...
  const response = await fetch(
    `${back_base_url}/users/dj-rest-auth/registration/`,
    {
      headers: {
...
async function handleEmailValify() {
  ...
  const response = await fetch(
    `${back_base_url}/users/dj-rest-auth/registration/resend-email/`,
    {
      headers: {
        "Content-Type": "application/json",
      },
...
async function pschange() {
  ...
  const response = await fetch(
    `${back_base_url}/users/dj-rest-auth/password/change/`,
    {
      headers: {
        Authorization: `Bearer ${token}`,
        "Content-Type": "application/json",
